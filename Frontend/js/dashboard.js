...
/* =====================================================
 1. VERIFICAR LOGIN E MOSTRAR USUÁRIO
===================================================== */
...
/* =====================================================
 5. ANIMAÇÃO DO SCORE
===================================================== */
const scoreElemento = document.querySelector(".security-card h3");
if (scoreElemento) {
 let valorFinal = 94;
 let valorAtual = 0;
 const intervalo = setInterval(function () {
   valorAtual++;
   scoreElemento.textContent = valorAtual + "%";
...
/* =====================================================
 6. GRÁFICO
===================================================== */
const barras = document.querySelectorAll(".chart div");
barras.forEach(function (barra, index) {
 const alturaOriginal = barra.style.height;
 barra.style.height = "0";
 setTimeout(function () {
   barra.style.height = alturaOriginal;
...
/* =====================================================
 8. MENU LATERAL
===================================================== */
const menuItens = document.querySelectorAll(".sidebar nav a");
menuItens.forEach(function (item) {
 item.addEventListener("click", function () {
   ...
   if (texto.includes("Nova Análise")) {
     ...
     mostrarMensagem("Área de projetos em desenvolvimento.");
   }
   else if (texto.includes("Relatórios")) {
     window.location.href = "reports.html";
   }
   else if (texto.includes("Vulnerabilidades")) {
     mostrarMensagem("Área de vulnerabilidades em desenvolvimento.");
   }
   else if (texto.includes("Configurações")) {
     mostrarMensagem("Configurações em desenvolvimento.");
   }
 });
});

/* =====================================================
 9. SISTEMA DE MENSAGEM
===================================================== */
function mostrarMensagem(mensagem) {
 ...
 alerta.style.background = "#21262D";
 alerta.style.border = "1px solid #30363D";
 alerta.style.color = "#F0F6FC";
 alerta.style.padding = "15px 22px";
 alerta.style.borderRadius = "10px";
 alerta.style.boxShadow = "0 10px 30px rgba(0,0,0,0.4)";
 alerta.style.zIndex = "9999";
 alerta.style.fontSize = "14px";
 alerta.style.animation = "fade .4s ease";
